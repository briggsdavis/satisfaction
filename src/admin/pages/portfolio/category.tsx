...
export const CategoryAdmin = () => {
  ...
  const addBullet = () => update({ id: category._id, bullets: [...category.bullets, ""] })
      ...
      <div className="border-b border-white/10 py-4">
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            onChange={(e) => update({ id: category._id, color: e.target.value })}
            ...
            >
              <div className="min-w-0">
                ...
                <p className="font-mono text-xs text-white/30">
                  {p.featured && <span className="mr-2 text-yellow-400/70">★ featured</span>}/
                  {p.slug}
                </p>
              </div>
