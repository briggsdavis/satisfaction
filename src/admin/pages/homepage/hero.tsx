...
const SLOTS = [
  { label: "Slot 1 — top-left (laptop)", ratio: "~3:2 (landscape)" },
  { label: "Slot 2 — upper-left (workspace)", ratio: "~3:2 (landscape)" },
  { label: "Slot 3 — top-centre (icon)", ratio: "1:1 (square)" },
  { label: "Slot 4 — top-right (UI screenshot)", ratio: "~16:7 (wide landscape)" },
  { label: "Slot 5 — left (studio)", ratio: "~5:3 (landscape)" },
  { label: "Slot 6 — centre-left (graphic)", ratio: "~1:1 (near-square)" },
  { label: "Slot 7 — right (logo card)", ratio: "~6:7 (near-square)" },
  { label: "Slot 8 — far-right (camera lens)", ratio: "1:1 (square)" },
  { label: "Slot 9 — bottom-left (phone mockup)", ratio: "~3:4 (portrait)" },
  { label: "Slot 10 — bottom-right (lifestyle)", ratio: "~16:9 (landscape)" },
]
