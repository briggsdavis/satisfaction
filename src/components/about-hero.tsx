...
const marqueeText = Array(10).fill("SOCIAL SATISFACTION").join("  \u00B7  ").concat("  \u00B7  ")

const spanClass = "massive-text text-xs tracking-[0.25em] text-white/30 uppercase whitespace-nowrap"
...
export const AboutHero = () => {
  const [scrollDistance, setScrollDistance] = useState(() => window.innerHeight * 0.5)
  ...
  const overlay = (
    <motion.div
      ...
      className="pointer-events-none fixed inset-0 z-[998] flex h-screen w-full items-center justify-center overflow-hidden bg-black"
    >
