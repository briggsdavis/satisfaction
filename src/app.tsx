...
import { SmoothScroll, SmoothScrollProvider, useSmoothScroll } from "./components/smooth-scroll"
...
const AboutCanvasInner = () => {
  ...
  const scrollOpacity = useTransform(activeY, [heroEnd, heroEnd + window.innerHeight * 0.3], [0, 1])
