...
export const HeroCanvas = () => {
  ...
  const scrollOffset = useTransform(activeY, (y) => (y > animationEnd ? -(y - animationEnd) : 0))
  ...
  return (
    <motion.div className="pointer-events-none fixed inset-0 z-[4]" style={{ y: scrollOffset }}>
...
export const Hero = () => {
  return (
    <section
      ...
      style={{
        background: "radial-gradient(ellipse 80% 80% at 50% 42%, #0c0c18 0%, #000000 62%)",
      }}
    >
