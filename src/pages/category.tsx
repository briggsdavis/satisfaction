...
const CtaBlock = ({
  ...
  <Link
    to="/contact"
    className={`group relative flex items-center justify-center rounded-[16px] border border-white/80 bg-black transition-all duration-500 hover:bg-white ${className}`}
  >
